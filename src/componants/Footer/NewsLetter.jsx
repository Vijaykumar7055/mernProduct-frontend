...
const Newsletter = () => {
  ...
  return (
    ...
    >
      <div className=" p-8 bg-opacity-90  rounded-lg ">
        ...
        <form
          ...
          className="space-y-6 w-full flex flex-col md:flex-row items-center justify-center  gap-5"
        >
          <div className="mt-4">
            <input
              type="email"
              id="email"
              className="w-[90%] px-4 py-2 mt-2 text-zinc-900 bg-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold"
          ...
          <button
            type="submit"
            className=" py-2 px-4  bg-blue-600 text-white font-extrabold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75 transition-transform transform hover:scale-105"
          >
            Subscribe
          </button>
        </form>
        {message && (
          <p className="mt-4 text-center text-green-400 font-extrabold">
            {message}
          </p>
        )}
      </div>
